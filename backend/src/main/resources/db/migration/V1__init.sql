...
CREATE TABLE chat_room (
    ...
    CONSTRAINT fk_chatroom_buyer FOREIGN KEY (buyer_id) REFERENCES user (id),
    CONSTRAINT fk_chatroom_seller FOREIGN KEY (seller_id) REFERENCES user (id),
...
CREATE TABLE transaction (
    ...
    CONSTRAINT uk_transaction_item UNIQUE (item_id),
    CONSTRAINT uk_transaction_chatroom UNIQUE (chat_room_id)
);
